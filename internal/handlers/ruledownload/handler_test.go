...
var (
	_ ruledownloadCursorService = mockCursorService(nil)
	_ globalRuleDownloader      = mockGlobalRuleDownloader(nil)
	_ feedRuleDownloader        = mockFeedRuleDownloader(nil)
	_ machineRuleDownloder      = mockMachineRuleDownloader(nil)
)
